...
WebUI.click(findTestObject('Account repository/Page_Contacts related/EDM contact'))

WebUI.setText(findTestObject('Account repository/Page_Contacts related/input EDM contact'), findTestData('Account Test Data/D17').getValue(
        14, 1))

WebUI.sendKeys(findTestObject('Account repository/Page_Contacts related/input EDM contact'), Keys.chord(Keys.ENTER))
