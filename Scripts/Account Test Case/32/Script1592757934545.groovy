...
WebUI.click(findTestObject('Account repository/Page_Contacts related/a_OldSales2 acti rel'))
...
WebUI.click(findTestObject('Account repository/Page_Opportunities (1)/td_Acer'))

WebUI.switchToDefaultContent()

WebUI.click(findTestObject('Account repository/Page_Opportunities (1)/status MC opportunity'))

WebUI.setText(findTestObject('Account repository/Page_Opportunities (1)/input status MC opportunity'), findTestData('Account Test Data/D19').getValue(
        11, 1))

WebUI.sendKeys(findTestObject('Account repository/Page_Opportunities (1)/input status MC opportunity'), Keys.chord(Keys.ENTER))

WebUI.click(findTestObject('Account repository/Page_Opportunities (1)/Configuration opportunity'))

WebUI.setText(findTestObject('Account repository/Page_Opportunities (1)/input Configuration opportunity'), findTestData(
        'Account Test Data/D19').getValue(12, 1))

WebUI.sendKeys(findTestObject('Account repository/Page_Opportunities (1)/input Configuration opportunity'), Keys.chord(Keys.ENTER))

WebUI.setText(findTestObject('Account repository/Page_Opportunities (1)/input_E_listPrice1 opportunity'), findTestData('Account Test Data/D19').getValue(
        13, 1))
