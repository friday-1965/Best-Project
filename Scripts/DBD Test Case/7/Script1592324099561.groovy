...
WebUI.setText(findTestObject('Not in DBD/Page_Accounts/input__accountname'), findTestData('DBD Test Data/D4').getValue(1, 
        1))
...
WebUI.setText(findTestObject('Not in DBD/Page_Accounts/input Customer Segment'), findTestData('DBD Test Data/D4').getValue(
        3, 1))
...
WebUI.setText(findTestObject('Not in DBD/Page_Accounts/New Select/input Company level 1'), findTestData('DBD Test Data/D4').getValue(
        4, 1))
...
WebUI.setText(findTestObject('Not in DBD/Page_Accounts/input japanese'), findTestData('DBD Test Data/D4').getValue(5, 1))

WebUI.sendKeys(findTestObject('Not in DBD/Page_Accounts/input japanese'), Keys.chord(Keys.ENTER))

WebUI.setText(findTestObject('Not in DBD/Page_Accounts/Purchasing'), findTestData('DBD Test Data/D4').getValue(6, 1))

WebUI.setText(findTestObject('Not in DBD/Page_Accounts/Branch ID'), findTestData('DBD Test Data/D4').getValue(7, 1))
...
WebUI.setText(findTestObject('Not in DBD/Page_Accounts/Phone'), findTestData('DBD Test Data/D4').getValue(9, 1))

WebUI.setText(findTestObject('Not in DBD/Page_Accounts/Address'), findTestData('DBD Test Data/D4').getValue(10, 1))
...
WebUI.setText(findTestObject('Not in DBD/Page_Accounts/Tax NO'), findTestData('DBD Test Data/D4').getValue(12, 1))
